...
import { Heart, MessageCircle, User as UserIcon, LogOut, Menu, X, ChevronDown } from 'lucide-react'
          ...
          <div className="md:hidden pb-4 border-t border-gray-200 mt-2 pt-4">
            ...
            {user ? (
              <div className="space-y-3">
                <Link
                  href="/sell"
                  className="block px-4 py-2 text-sm font-medium text-white bg-black rounded-md hover:bg-gray-800 text-center"
                >
                  Sell now
                </Link>
                <Link
                  href="/likes"
                  className="block px-4 py-2 text-sm font-medium text-gray-700 hover:text-red-500"
                >
                  Likes
                </Link>
                <Link
              ...
              <div className="space-y-3">
                <Link
                  href="/signup"
                  className="block px-4 py-2 text-sm font-medium border border-gray-300 rounded-md hover:border-gray-400 text-center"
                >
                  Sign up
                </Link>
                <Link
                  href="/login"
                  className="block px-4 py-2 text-sm font-medium text-gray-700 hover:text-black text-center"
                >
                  Log in
                </Link>
              </div>
